...
@section('content')
    ...
    @if($user->role_id == 1)
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-bold text-gray-700 mb-10">Recent Companies</h3>
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 text-gray-500">+{{ $company->country_code }}{{ $company->phone }}</td>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 text-gray-500">+{{ $branch->country_code }}{{ $branch->phone }}</td>
                    </tr>
                    @empty
                    <tr>
